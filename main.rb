...
user5 = Lib::Entity::Reader.new('user5', 'user5@gmail.com', 'Lviv', 'Lvivska street', 15)
user6 = Lib::Entity::Reader.new('user6', 'user6@gmail.com', 'Lviv', 'Lvivska street', 12)
# library.add(user1)
# #library.add(user2)
# #library.add(user3)
# #library.add(user4)
...
user5_order1 = Lib::Entity::Order.new(pushkin_book_dubrovski, user5)
user5_order2 = Lib::Entity::Order.new(gogol_book_dead, user5)
user5_order3 = Lib::Entity::Order.new(gogol_book_taras_bulba, user5)
user6_order1 = Lib::Entity::Order.new(pushkin_book_dubrovski, user6)
...
library.add(user5_order1)
library.add(user5_order2)
library.add(user5_order3)
library.add(user6_order1)
